...
if (subfolder == "output/Original"){
  usehh <-unique(kenya$hhcode) #if using whole data set
}else if (subfolder == "output/Matched"){
...
#-- DIAGNOSTICS ------------
#trace plots
stan_trace(stunting_sampled, par = c("phi","gamma1","gamma2[5]", "gamma2[1]", "sigma_a", "sigma_v",  "beta[4]", "beta[7]","rho", "lp__"))
